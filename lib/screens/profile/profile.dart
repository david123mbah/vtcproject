        ...
        body: SingleChildScrollView(
            child: Column(
              ...
              Container(
                ...
                child: Text(
                  "francfon@gmail.com",
                  style: AppStyles.smallBodyText.copyWith(color: Colors.blue.withOpacity(0.6)),
                ),
              ),
              const SizedBox(
                height: 30,
                    ...
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Text(
                            "Logout",
                            style: AppStyles.bodyText.copyWith(color: Colors.red.withOpacity(0.8)),
                          ),
                          const Spacer(),
                          Icon(
                            Icons.arrow_forward_ios,
